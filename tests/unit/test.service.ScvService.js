...
describe('service.CsvService', function() {
  ...
  before(function(done) {
    Service = injector.getInstance('CsvService');
    done();
  });

  describe('.uploadFromFile(filepath, options)', function() {

    it.skip('should be able to convert info from file to an array without options', function(done) {
    ...
    it.skip('should be able to convert info from file to an array with options', function(done) {
    ...
    it.skip('should be able get error if file have not valid info', function(done) {
      var filepath  = [config.pathToTestCsvFiles, 'test_file_1.csv'].join('');
      var options   = {
        delimiter: ';',
        comment: '#'
    ...
    it.skip('should be able get error if file do not exist', function(done) {
  ...
  describe('.getAllPossibleTypes()', function() {
    it.skip('should be able to find all possible types', function(done) {
    ...
    it.skip('should be able to get empty array if directory do not have necessary files', function(done) {
    ...
    it.skip('should be able get error if directory do not exist', function(done) {
  ...
  describe('.readCsvSchemaFile(type)', function() {
    it.skip('should be able to get necessary schema', function(done) {
      var typesPath = config.pathToCsvSchemaFiles;
  ...
  describe('.readCsvFileByUrl(url, filename)', function() {
    it.skip('should be able to read csv file from url and save it with default name', function(done) {
    ...
    it.skip('should be able to read csv file from url and save it with specific name', function(done) {
      var filePath = config.pathToCsvFiles
        , url = config.urlToTestCsvFile //i upload file before
        , filename = 'myFileName';
    ...
    it.skip('should be able get error if directory do not exist', function(done) {
      ...
      expect(oldPath).to.not.equal(filePath);
      expect(fs.existsSync(filePath)).to.be.false;
  ...
  describe('.guessHeadersByName(obj)', function() {
    it.skip('should be able to return data with the most probable headers', function(done) {
  ...
  describe('.handleExamineProcess(data)', function() {
    ...
    it.skip('should be able to return preparing data', function(done) {
      ...
      .then(function(result) {
        ...
        expect(result.columns[0]).to.have.property('value').and.equal(csv1[1][0]);
        ...
        expect(result.columns[5]).to.have.property('value').and.equal(csv1[1][5]);
        ...
        expect(result.columns[10]).to.have.property('value').and.equal(csv1[1][10]);
        ...
        expect(result.columns[15]).to.have.property('value').and.equal(csv1[1][15]);
    ...
    it.skip('should be able get error if directory for save csv file do not exist', function(done) {
      var oldPath = config.pathToCsvFiles;
      ...
      expect(oldPath).to.not.equal(config.pathToCsvFiles);
  ...
  describe('.reorganizeDataByColumns(data)', function() {
    it.skip('should be able to reorganize data', function(done) {
      var data = {
        type: 'exampleEmployee',
        url: config.urlToTestCsvFile,
        filename: 'myNewCsvFile',
  ...
  describe('.handleSubmitDraftProcess(data)', function() {
    it.skip('should be able to return reorganized data', function(done) {
  ...
  describe('.handleSubmitFinalProcess(data)', function() {
    it.skip('should be able to return error if servece do not exist', function(done) {
      // -1: data that will not be included in the result
      var data = {
        columns: [0, 1, 2, -1, 4, 5, 6, 7, 8, 9, -1, 11, 12, 13, 14, 15, 16, -1],
        path: [config.pathToTestCsvFiles, 'examplePersonal.csv'].join(''),
